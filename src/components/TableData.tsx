...
const TableData: React.FC<TableDataProps> = ({ fields, data, onGenerateNomina, onEdit, onDelete, buttonRefs }) => {
    return (
                ...
                {data.map((item, index) => (
                    <div
                        ...
                        <div className='flex justify-center gap-2'>
                            ...
                            <DropdownMenu
                                // Referencia del botón si se necesita en la lógica de Dropdown
                                buttonRef={el => {
                                    if (buttonRefs) {
